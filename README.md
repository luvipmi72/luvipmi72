...
現在は職業訓練校「IoTデバイス開発科」で、
C言語や組込みLinux、Raspberry Pi、ネットワークなどを学習しています。

訓練生4人でGitHubを活用したチーム開発にも取り組み、
ソースコード管理やプルリクエストを用いた開発の流れを経験しました。

今後も継続的に学ぶ姿勢を大切にし、
実務経験を積みながら周囲から信頼されるITエンジニアを目指しています。
...
BlenderとIoT技術を組み合わせたオリジナル作品を制作しています。

**制作目的**

センサーから取得した情報をもとに、
LEDの光り方やOLEDディスプレイの表示を変化させる
IoTデバイスの制作を目指しています。

プログラムの作成だけでなく、
電子回路の配線やBlenderを使用した筐体設計、
3Dプリンターによる制作まで行い、
実際に使用できる一つのデバイスとして完成させることが目標です。
